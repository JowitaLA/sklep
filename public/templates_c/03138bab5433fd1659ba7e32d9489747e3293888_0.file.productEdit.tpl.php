<?php
/* Smarty version 4.3.4, created on 2024-11-07 17:14:16
  from 'C:\xampp\htdocs\Sklep\app\views\management\productEdit.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_672ce75880e5f1_49739432',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '03138bab5433fd1659ba7e32d9489747e3293888' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Sklep\\app\\views\\management\\productEdit.tpl',
      1 => 1730992809,
      2 => 'file',
    ),
  ),
...
function content_672ce75880e5f1_49739432 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_1805040063672ce7587e8410_52261026', 'content');
$_smarty_tpl->inheritance->endChild($_smarty_tpl, "templates/edit.tpl");
}
/* {block 'content'} */
class Block_1805040063672ce7587e8410_52261026 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_1805040063672ce7587e8410_52261026',
  ),
);
        ...
        <div class="row g-0 mb-0">
            ...
            <div class="col-md-8">
                ...
                <div class="form-floating">
                    <input type="text" class="form-control top-left-field" name="name" id="name" value="<?php echo $_smarty_tpl->tpl_vars['product']->value['name'];?>
">
            ...
            <div class="col-md-2">
                ...
                <div class="form-floating">
                    <input type="text" class="form-control top-mid-field" name="price" id="price" value="<?php echo $_smarty_tpl->tpl_vars['product']->value['price'];?>
">
            ...
            <div class="col-md-2">
                ...
                <div class="form-floating">
                    <input type="text" class="form-control top-right-field" name="amount" id="amount"
                        value="<?php echo $_smarty_tpl->tpl_vars['product']->value['amount'];?>
"> <label for="amount">Ilość</label>
        ...
        <div class="form-floating form-control down-field" name="Opis">
            ...
            <div id="description" contenteditable="true" spellcheck="false" style="min-height:100px;"><?php echo $_smarty_tpl->tpl_vars['product']->value['description'];?>
</div>
        </div>
...
"
                    <?php if (in_array($_smarty_tpl->tpl_vars['category']->value['id_category'],array_column($_smarty_tpl->tpl_vars['relatedCategories']->value,'id_category'))) {?> checked <?php }?>>
...
>
        ...
        const existingImagesObject = JSON.parse('<?php echo strtr((string)$_smarty_tpl->tpl_vars['existingImages']->value, array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", 
                       "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S",
                       "`" => "\\`", "\${" => "\\\$\{"));?>
');
        ...
        existingImages.forEach(async (imagePath, index) => {
            const imgPath = '../public/assets/img/products/<?php echo $_smarty_tpl->tpl_vars['product']->value['url'];?>
/' + imagePath;
