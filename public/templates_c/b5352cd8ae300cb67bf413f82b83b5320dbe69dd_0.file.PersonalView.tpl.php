<?php
/* Smarty version 4.3.4, created on 2024-11-28 00:59:36
  from 'C:\xampp\htdocs\Sklep\app\views\PersonalView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_6747b268a82447_73411849',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b5352cd8ae300cb67bf413f82b83b5320dbe69dd' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Sklep\\app\\views\\PersonalView.tpl',
      1 => 1732732840,
      2 => 'file',
    ),
  ),
...
function content_6747b268a82447_73411849 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_3210719066747b268a59d89_85496667', 'content');
$_smarty_tpl->inheritance->endChild($_smarty_tpl, "templates/secondary.tpl");
}
/* {block 'content'} */
class Block_3210719066747b268a59d89_85496667 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_3210719066747b268a59d89_85496667',
  ),
);
...
userEditPersonalData" method="POST">
                                    <div class="mb-3">
                                        <label for="name" class="form-label">Imię</label>
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Imię"
                                            value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['user']->value['name'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
">
                                    </div>
                                    <div class="mb-3">
                                        <label for="surname" class="form-label">Nazwisko</label>
                                        <input type="text" class="form-control" id="surname" name="surname"
                                            placeholder="Nazwisko" value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['user']->value['surname'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
">
                                    </div>
                                    <div class="mb-3">
                                        <label for="mail" class="form-label">Email</label>
                                        <input type="email" class="form-control" id="mail" name="mail" placeholder="E-mail"
                                            value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['user']->value['mail'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
" required>
                                    </div>
                    ...
                    <div class="row m-2">
                        ...
                        <div class="col-md-6">
                            <div class="bg-body-secondary p-3 rounded border mt-3">
                                ...
                                <form action="<?php echo $_smarty_tpl->tpl_vars['conf']->value->action_url;?>
userEditDeliveryAddress" method="POST">

                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                            <label for="firstName" class="form-label">Imię</label>
                                            <input type="text" class="form-control" name="firstName" id="firstName"
                                                placeholder="Imię" value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['deliveryAddress']->value['first_name'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
"
                                                required>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" class="form-control" name="lastName" id="lastName"
                                                placeholder="Nazwisko" value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['deliveryAddress']->value['last_name'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
"
                                                required>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="email" class="form-control" name="email" id="email"
                                                placeholder="E-mail" value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['deliveryAddress']->value['email'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
" required>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" name="phone_number" id="phone_number"
                                                ...
                                                value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['deliveryAddress']->value['phone_number'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
" required
                                        ...
                                        <div class="col-8">
                                            ...
                                            <input type="text" class="form-control" name="street" id="street"
                                                placeholder="Ulica" value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['deliveryAddress']->value['street'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
" required>
                                            <div class="invalid-feedback">
                                                Proszę wpisać ulicę.
                                            </div>
                                        ...
                                        <div class="col-4">
                                            ...
                                            <input type="text" class="form-control" name="house_number" id="house_number"
                                                placeholder="Kod" value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['deliveryAddress']->value['house_number'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
"
                                                required>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <input type="text" class="form-control" name="postal_code" id="postal_code"
                                                placeholder="__-___" value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['deliveryAddress']->value['postal_code'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
"
                                        ...
                                        <div class="col-8">
                                            ...
                                            <input type="text" class="form-control" name="city" id="city"
                                                placeholder="Miasto" value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['deliveryAddress']->value['phone_number'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
"
                                                required>
                                            <div class="invalid-feedback">
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['isDeliveryAddress']->value) {?>
                                <form action="<?php echo $_smarty_tpl->tpl_vars['conf']->value->action_url;?>
userEditDeleteDeliveryAddress" method="POST" class="ms-3">
                    ...
                    <div class="col-md-6">
                        <div class="bg-body-secondary p-3 rounded border mt-3">
                            ...
                            <form action="<?php echo $_smarty_tpl->tpl_vars['conf']->value->action_url;?>
userEditBillingAddress" method="POST">

                                <div class="row g-3">
                                    <div class="col-sm-6">
                                        <label for="firstName" class="form-label">Imię</label>
                                        <input type="text" class="form-control" name="firstName" id="firstName"
                                            placeholder="Imię" value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['billingAddress']->value['first_name'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
" required>
                                        <div class="invalid-feedback">
                                            Proszę wpisać imię.
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <label for="lastName" class="form-label">Nazwisko</label>
                                        <input type="text" class="form-control" name="lastName" id="lastName"
                                            placeholder="Nazwisko" value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['billingAddress']->value['last_name'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
" required>
                                        <div class="invalid-feedback">
                                            Proszę wpisać nazwisko.
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <label for="email" class="form-label">E-mail</label>
                                        <input type="email" class="form-control" name="email" id="email"
                                            placeholder="E-mail" value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['billingAddress']->value['email'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
" required>
                                        <div class="invalid-feedback">
                                            Proszę wpisać prawidłowy e-mail.
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <label for="phone_number" class="form-label">Numer telefonu</label>
                                        <input type="text" class="form-control" name="phone_number" id="phone_number"
                                            placeholder="+48 ___ ___ ___" value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['billingAddress']->value['phone_number'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
"
                                    ...
                                    <div class="col-8">
                                        <label for="street" class="form-label">Ulica</label>
                                        <input type="text" class="form-control" name="street" id="street"
                                            placeholder="Ulica" value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['billingAddress']->value['street'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
" required>
                                        <div class="invalid-feedback">
                                            Proszę wpisać ulicę.
                                        </div>
                                    ...
                                    <div class="col-4">
                                        <label for="house_number" class="form-label">Nr domu/lokalu</label>
                                        <input type="text" class="form-control" name="house_number" id="house_number"
                                            placeholder="Kod" value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['billingAddress']->value['house_number'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
" required>
                                        <div class="invalid-feedback">
                                            Proszę wpisać numer domu/lokalu.
                                        </div>
                                    ...
                                    <div class="col-4">
                                        <label for="postal_code" class="form-label">Kod pocztowy</label>
                                        <input type="text" class="form-control" name="postal_code" id="postal_code"
                                            placeholder="__-___" value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['billingAddress']->value['postal_code'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
" required
                                    ...
                                    <div class="col-8">
                                        <label for="city" class="form-label">Miasto</label>
                                        <input type="text" class="form-control" name="city" id="city"
                                            placeholder="Miasto" value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['billingAddress']->value['phone_number'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
" required>
                                        <div class="invalid-feedback">
                                            Proszę wpisać miasto.
                                        </div>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['isBillingAddress']->value) {?>
                            <form action="<?php echo $_smarty_tpl->tpl_vars['conf']->value->action_url;?>
userEditDeleteBillingAddress" method="POST" class="ms-3">
                                <button type="submit" class="btn btn-danger">Usuń adres</button>
                            </form>
                            <?php }?>
                        </div>
                ...
                <form action="<?php echo $_smarty_tpl->tpl_vars['conf']->value->action_url;?>
userEditDeleteAccount" method="POST">
