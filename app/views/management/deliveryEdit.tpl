...
{block name=content}
    <form method="post" action="{$conf->action_url}updateDelivery">
        ...
        <div class="form-floating">
            <input type="text" class="form-control down-field" name="estimated_time" id="estimated_time" value="{$delivery.estimated_time}">
