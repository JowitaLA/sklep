...
{block name=content}
    <form method="post" action="{$conf->action_url}updateSubpage" enctype="multipart/form-data">
        <div class="form-floating form-control solo-field" name="Opis">
            ...
            <div id="description" contenteditable="true" spellcheck="false" style="min-height:100px;">{$subpage.description}
            </div>
        </div>
